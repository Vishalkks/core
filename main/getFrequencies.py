...
genreFreqsTrain, allFreqsTrain, numSongsTrain = evaluateFrequencies(directories.PATH_TRAIN)
...
genreFreqsVal, allFreqsVal, numSongsVal = evaluateFrequencies(directories.PATH_VAL)
...
genreFreqsTest, allFreqsTest, numSongsTest = evaluateFrequencies(directories.PATH_TEST)
